                        ...
                        <div class="clean-blog-post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5"><img class="rounded img-fluid"
                                                           src="images/<?php echo $row['post_image']; ?>"></div>
                                <div class="col-lg-7">
                                    <h3 style="font-family: Montserrat, sans-serif;"><a
                                                href="post.php?p_id=<?php echo $p_id; ?>"><?php echo $row['post_title']; ?></a>
                                    </h3>
                                    <div class="info"><span class="text-muted"><?php echo $row['post_date']; ?> by&nbsp;<a
                                                    href=""><?php echo $row['post_author']; ?></a></span></div>
                                    ...
                                    <a class="btn btn-outline-primary btn-sm" role="button"
                                       href="post.php?p_id=<?php echo $p_id; ?>">Read More</a>
